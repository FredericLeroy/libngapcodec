...
ber_type_decoder_f NewSecurityContextInd_decode_ber;
der_type_encoder_f NewSecurityContextInd_encode_der;
xer_type_decoder_f NewSecurityContextInd_decode_xer;
xer_type_encoder_f NewSecurityContextInd_encode_xer;
oer_type_decoder_f NewSecurityContextInd_decode_oer;
