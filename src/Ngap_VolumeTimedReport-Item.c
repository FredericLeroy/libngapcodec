...
asn_TYPE_member_t asn_MBR_Ngap_VolumeTimedReport_Item_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Ngap_VolumeTimedReport_Item, startTimeStamp),
		...
		0,
		{ &asn_OER_memb_Ngap_startTimeStamp_constr_2, &asn_PER_memb_Ngap_startTimeStamp_constr_2,  memb_Ngap_startTimeStamp_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Ngap_VolumeTimedReport_Item, endTimeStamp),
		...
		&asn_DEF_OCTET_STRING,
		0,
		{ &asn_OER_memb_Ngap_endTimeStamp_constr_3, &asn_PER_memb_Ngap_endTimeStamp_constr_3,  memb_Ngap_endTimeStamp_constraint_1 },
		0, 0, /* No default value */
		"endTimeStamp"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct Ngap_VolumeTimedReport_Item, usageCountUL),
		...
		&asn_DEF_INTEGER,
		0,
		{ &asn_OER_memb_Ngap_usageCountUL_constr_4, &asn_PER_memb_Ngap_usageCountUL_constr_4,  memb_Ngap_usageCountUL_constraint_1 },
		0, 0, /* No default value */
		"usageCountUL"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct Ngap_VolumeTimedReport_Item, usageCountDL),
		...
		&asn_DEF_INTEGER,
		0,
		{ &asn_OER_memb_Ngap_usageCountDL_constr_5, &asn_PER_memb_Ngap_usageCountDL_constr_5,  memb_Ngap_usageCountDL_constraint_1 },
		0, 0, /* No default value */
		"usageCountDL"
		},
