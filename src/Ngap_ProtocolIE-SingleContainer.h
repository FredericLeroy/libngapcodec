...
typedef Ngap_UP_TNLInformation_ExtIEs_t	 Ngap_ProtocolIE_SingleContainer_127P23_t;
typedef Ngap_UPTransportLayerInformation_ExtIEs_t	 Ngap_ProtocolIE_SingleContainer_127P24_t;
typedef Ngap_UserLocationInformation_ExtIEs_t	 Ngap_ProtocolIE_SingleContainer_127P25_t;
typedef Ngap_WarningAreaList_ExtIEs_t	 Ngap_ProtocolIE_SingleContainer_127P26_t;
